...
Please read the [User Guide Posts](http://brimosoft.nl/category/galleries/eazyest-gallery/user-guide-eazyest-gallery/) and the [Release Post](http://brimosoft.nl/2013/06/04/some-minor-bugs-fixed-in-eazyest-gallery/) at the Plugin Web Site.
...
= 0.1.3 =
* __0.1.3__ Some minor bugs fixed 
